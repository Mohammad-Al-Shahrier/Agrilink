...
/* Cache fetched products so search doesn't re-fetch */
let _allProducts = [];
...
function renderProducts(products = []) {
  ...
  /* ---- Determine base path (index.html vs pages/*.html) ---- */
  const inPagesFolder = window.location.pathname.includes("/pages/");
  const detailsPath   = inPagesFolder
  ...
  container.innerHTML = products.map(product => {
    ...
    /* Build image URL — handles both "uploads/..." and full URLs */
...
/* =====================================================
   QUICK ADD TO CART (homepage — no page change)
===================================================== */
